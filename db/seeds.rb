...
event0 = Event.create!{
  title = "Le traitement médiatique de l’urgence climatique - Paris"
...
event2 = Event.create!{
  title = "International Conference on Climate Change and Global Warming - London"
